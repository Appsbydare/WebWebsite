...
const SplashSVG = ({ gradId, clipId }: { gradId: string; clipId: string }) => (
    <div
...
export default function RegisterPage() {
        ...
        return (
            <main className="min-h-screen bg-black flex items-center justify-center px-4 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center max-w-md">
                    ...
                    <Link
                        href="/login"
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-white transition-all hover:opacity-90 hover:scale-[1.01]"
    ...
    return (
        <main className="min-h-screen bg-black flex items-center justify-center px-4 py-16 relative overflow-hidden">
            <PageBackground />
                ...
                <div className="flex flex-col items-center mb-10">
                    <Link href="/" className="flex items-center group relative">
                        <div className="relative inline-block">
                            <SplashSVG gradId="splashRegisterGrad" clipId="splashRegisterClip" />
                    ...
                    <h1 className="text-3xl font-bold text-white mt-8 mb-1">Create account</h1>
                    <p className="text-white/40 text-sm">Track your orders and project status</p>
                </div>
                ...
                >
                    ...
                    <form onSubmit={handleRegister} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold tracking-widest uppercase text-white/50">Full Name</label>
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold tracking-widest uppercase text-white/50">Email</label>
                            <div className="relative">
                        ...
                        <div className="space-y-1.5">
                            <label className="text-xs font-semibold tracking-widest uppercase text-white/50">Password</label>
                            <div className="relative">
